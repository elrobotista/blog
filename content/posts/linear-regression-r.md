...
categories = []
imgs = []
cover = "/img/movies-cover.jpg"  # image show on top
...
names(movies)
```
![names data](/img/movies-names-out.png)
...
str(movies)
```
![struct data](/img/movies-str-data.PNG)
...
```
![summary stats](/img/summary_stats_runtime.PNG)
...
```
![histogram runtime](/img/histogram-runtime.PNG)
...
```
![boxplot runtime](/img/boxplot-runtime.PNG)
...
```
![category summary](/img/cat-sum.PNG)
```R
...
plot_grid(g1,g2,g3)
```
![cat grid](/img/multiple-hist-cat.PNG)
...
```
![multiple boxplot](/img/boxplot-cat-mul.PNG)
...
```
![scatterplot runtime imdb](/img/scatter-plot-runtime.PNG)
...
```
![audience score](/img/audience-score.PNG)
...
```
![category critics](/img/critics-category.PNG)
...
```
![random scatter](/img/random-scatter-around-0.PNG)
...
```
![nearly normal cero](/img/nearly-normal-cero.PNG)
...
```
![residual patterns](/img/residual-any-pattern.PNG)
